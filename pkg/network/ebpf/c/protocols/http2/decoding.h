...
SEC("cgroup/skb/http2_handle_first_frame")
...
SEC("cgroup/skb/http2_headers_parser")
...
SEC("cgroup/skb/http2_dynamic_table_cleaner")
...
SEC("cgroup/skb/http2_eos_parser")
