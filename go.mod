...
require (
	...
	github.com/DataDog/datadog-agent/comp/core/log/def v0.56.0-rc.3
	github.com/DataDog/datadog-agent/comp/core/log/impl v0.56.0-rc.3
	github.com/DataDog/datadog-agent/comp/core/log/impl-trace v0.56.0-rc.3
	github.com/DataDog/datadog-agent/comp/core/log/mock v0.56.0-rc.3
	...
	github.com/DataDog/datadog-agent/comp/core/tagger/utils v0.58.0-devel
