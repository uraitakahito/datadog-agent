...
func (v *vmUpdaterSuite) TestAgentUnitsLoaded() {
	...
	v.Env().RemoteHost.MustExecute(fmt.Sprintf(`sudo %v/bin/updater/updater -url "oci://us-docker.pkg.dev/datadog-sandbox/updater-dev/agent@sha256:868287768e7f224fbf210a864c3da614ab19cde23ddbd8a94e747c915d8c9ab1"`, bootUpdaterDir))
